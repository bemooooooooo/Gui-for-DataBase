...
public:
    ...
    void createSchema(const HttpRequestPtr& req,
                     std::function<void(const HttpResponsePtr&)>&& callback);
    void getSchemas(const HttpRequestPtr& req,
                   std::function<void(const HttpResponsePtr&)>&& callback);
    void getSchema(const HttpRequestPtr& req,
                  std::function<void(const HttpResponsePtr&)>&& callback);
    void updateSchema(const HttpRequestPtr& req,
                     std::function<void(const HttpResponsePtr&)>&& callback);
    void deleteSchema(const HttpRequestPtr& req,
                     std::function<void(const HttpResponsePtr&)>&& callback);
    void validateSchema(const HttpRequestPtr& req,
                       std::function<void(const HttpResponsePtr&)>&& callback);
    void generateSql(const HttpRequestPtr& req,
                    std::function<void(const HttpResponsePtr&)>&& callback);
};